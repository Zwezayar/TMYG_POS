                                                ...
                                                children: [
                                                    /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("select", {
                                                        ...
                                                        children: [
                                                            ...
                                                            }) : allCategories.map((name)=>/*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("option", {
                                                                    value: name,
                                                                    className: "jsx-c99c8882a51a21f8",
                                                                    children: name
                                                                }, name, false, {
                                                    ...
                                                    /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])(__TURBOPACK__imported__module__$5b$project$5d2f$components$2f$ui$2f$button$2e$tsx__$5b$app$2d$client$5d$__$28$ecmascript$29$__["Button"], {
                                                        ...
                                                        onClick: async ()=>{
                                                            ...
                                                            if (newCat && newCat.trim()) {
                                                                ...
                                                                try {
                                                                    let parentId = null;
                                                                    const { data: mainData, error: mainError } = await __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$supabaseClient$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["supabaseClient"].from('categories').select('id').eq('name', mainName).is('parent_id', null).maybeSingle();
                                                                    if (mainError) throw mainError;
                                                                    if (mainData) {
                                                                        parentId = mainData.id;
                                                                    } else {
                                                                        const { data: newMain, error: createError } = await __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$supabaseClient$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["supabaseClient"].from('categories').insert({
                                                                            name: mainName
                                                                        }).select('id').single();
                                                                    ...
                                                                    if (subName) {
                                                                        await __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$supabaseClient$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["supabaseClient"].from('categories').insert({
                                                                            name: subName,
                                                                            parent_id: parentId
                                                                        });
                                                                    }
...
_s3(PosPage, "66gF8vzKkdvhv3gVpvMNzcaB6ow=", false, function() {
    return [
...
//# sourceMappingURL=_ad93ee37._.js.map